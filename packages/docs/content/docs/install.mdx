---
title: Install
description: Install Ridge for desktop, web, or VS Code.
---

# Install

Ridge has three main surfaces:
...
Download the latest desktop build from the GitHub releases page or the project download page.
