---
title: Themes
description: Customize Ridge with built-in and user-defined themes.
---

# Themes

Ridge supports built-in themes and custom theme JSON files.
...
3. Open Ridge, then go to **Settings -> Theme -> Reload themes**.
