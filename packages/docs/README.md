# OpenAurora Docs Source

This package is the source-of-truth for OpenAurora public docs content.
...
Website rendering/deployment happens in `openaurora-website` (`apps/docs`).
