...
import type {
  OpenAuroraProjectAction,
  OpenAuroraProjectActionPlatform,
...
export const PROJECT_ACTIONS_UPDATED_EVENT = 'openaurora:project-actions-updated';
...
export const getCurrentProjectActionPlatform = (): OpenAuroraProjectActionPlatform => {
...
export const isProjectActionEnabledOnPlatform = (
  action: OpenAuroraProjectAction,
  platform: OpenAuroraProjectActionPlatform
): boolean => {
