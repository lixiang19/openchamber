...
export const HelpDialog: React.FC = () => {
  ...
  const shortcuts: ShortcutSection[] = [
    {
      category: t('help.categories.navigation'),
      items: [
        {
          id: 'open_command_palette',
          description: t('help.openCommandPalette'),
          icon: RiCommandLine,
          keys: '',
        },
        {
          id: 'open_help',
          description: t('help.showShortcuts'),
          icon: RiQuestionLine,
          keys: '',
        },
        {
          id: 'toggle_sidebar',
          description: t('help.toggleSessionSidebar'),
          icon: RiLayoutLeftLine,
          keys: '',
        },
        {
          keys: ["Tab"],
          description: t('help.cycleAgent'),
          icon: RiAiAgentLine,
        },
        {
          id: 'open_model_selector',
          description: t('help.openModelSelector'),
          icon: RiAiGenerate2,
          keys: '',
        },
        {
          id: 'cycle_thinking_variant',
          description: t('help.cycleThinkingVariant'),
          icon: RiBrainAi3Line,
          keys: '',
        },
        {
          keys: [`Shift + Alt + ${mod} + N`],
          description: t('help.newWindow'),
          icon: RiWindowLine,
        },
      ],
    },
    {
      category: t('help.categories.conversation'),
      items: [
        {
          id: 'new_chat',
          description: t('help.createConversation'),
          icon: RiAddLine,
          keys: '',
        },
        {
          id: 'new_chat_worktree',
          description: t('help.createWorktreeConversation'),
          icon: RiGitBranchLine,
          keys: '',
        },
        { id: 'focus_input', description: t('help.focusChatInput'), icon: RiText, keys: '' },
        {
          id: 'abort_run',
          description: t('help.abortActiveRun'),
    ...
    {
      category: t('help.categories.panels'),
      items: [
        {
          id: 'toggle_right_sidebar',
          description: t('help.toggleRightSidebar'),
          icon: RiLayoutRightLine,
          keys: '',
        },
        {
          id: 'open_right_sidebar_git',
          description: t('help.openRightSidebarGit'),
          icon: RiGitBranchLine,
          keys: '',
        },
        {
          id: 'open_right_sidebar_files',
          description: t('help.openRightSidebarFiles'),
          icon: RiLayoutRightLine,
          keys: '',
        },
        {
          id: 'open_right_sidebar_todo',
          description: t('help.openRightSidebarTodo'),
          icon: RiCheckboxMultipleLine,
          keys: '',
        },
        {
          id: 'cycle_right_sidebar_tab',
          description: t('help.cycleRightSidebarTab'),
          icon: RiLayoutRightLine,
          keys: '',
        },
        {
          id: 'toggle_terminal',
          description: t('help.toggleTerminalDock'),
          icon: RiWindowLine,
          keys: '',
        },
        {
          id: 'toggle_terminal_expanded',
          description: t('help.toggleTerminalExpanded'),
          icon: RiWindowLine,
          keys: '',
        },
        {
          id: 'toggle_context_plan',
          description: t('help.togglePlanContextPanel'),
          icon: RiTimeLine,
          keys: '',
        },
      ],
    ...
    {
      category: t('help.categories.interface'),
      items: [
        {
          id: 'cycle_theme',
          description: t('help.cycleTheme'),
          icon: RiPaletteLine,
          keys: '',
        },
        {
          keys: [`${mod} + 1...9`],
          description: t('help.switchProject'),
          icon: RiLayoutLeftLine,
        },
        {
          id: 'open_timeline',
          description: t('help.openTimeline'),
          icon: RiTimeLine,
          keys: '',
        },
        {
          id: 'toggle_services_menu',
          description: t('help.toggleServicesMenu'),
          icon: RiStackLine,
          keys: '',
        },
        {
          id: 'cycle_services_tab',
          description: t('help.cycleServicesTab'),
          icon: RiStackLine,
          keys: '',
        },
        {
          id: 'open_settings',
          description: t('help.openSettings'),
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="typography-meta text-muted-foreground">
                ...
                <ul className="space-y-0.5 typography-meta">
                  <li>
                    • {t('help.proTipPalettePrefix')}{renderShortcut('open_command_palette', `${mod} K`, shortcutOverrides)}{t('help.proTipPaletteSuffix')}
                  </li>
                  <li>
                    • {t('help.proTipRecentSessions')}
                  </li>
                  <li>
                    • {t('help.proTipTheme')}
                  </li>
