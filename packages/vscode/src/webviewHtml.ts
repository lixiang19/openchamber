...
export function getWebviewHtml(options: WebviewHtmlOptions): string {
  ...
  // 
  // Logo geometry matches OpenAuroraLogo.tsx:
...
<head>
  ...
  <style>
    ...
    /* Animation on inner logo only, like OpenAuroraLogo.tsx */
  ...
  <title>OpenAurora</title>
</head>
<body>
  <!-- Initial loading screen with simplified OpenAurora logo -->
  ...
  <script>
    ...
    window.__OPENAURORA_HOME__ = "${workspaceFolder.replace(/\\/g, '\\\\')}";
