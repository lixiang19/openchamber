# <picture><source media="(prefers-color-scheme: dark)" srcset="https://github.com/btriapitsyn/openaurora/raw/HEAD/docs/references/badges/openaurora-logo-dark.svg"><img src="https://github.com/btriapitsyn/openaurora/raw/HEAD/docs/references/badges/openaurora-logo-light.svg" width="32" height="32" align="absmiddle" /></picture> OpenAurora Desktop
...
Download from [Releases](https://github.com/btriapitsyn/openaurora/releases). Available for macOS (Apple Silicon and Intel).

> **Prerequisite:** [OpenCode CLI](https://opencode.ai) installed.

## What makes the desktop app special

- **Remote instances over SSH** - connect to remote OpenAurora servers with dedicated lifecycle and UX flows
...
- **Local + remote switching** - jump between local and remote OpenAurora instances
- **Native macOS integration** - menus, deep-links, auto-update, and polished window management

Plus everything from the shared OpenAurora UI: branchable timeline, Git sidebar, terminal, voice mode, and more.
...
- Configure in **Settings -> OpenAurora -> Remote Tunnel**.
...
```bash
git clone https://github.com/btriapitsyn/openaurora.git
cd openaurora
bun install
bun run desktop:dev
```
