...
## **Pi, everywhere.** Desktop. Browser. Phone.

### A Pi-native interface powered by the embedded Pi SDK. Review diffs, manage agents, run dev servers, and keep the big picture while your AI codes.
...
- **Cross-device continuity**: Start in TUI, continue on tablet/phone, return to terminal - same Pi session
- **Remote access**: Use Pi from anywhere via browser
...
> **Prerequisite:** Node.js 20+ for the web server. OpenCode CLI is no longer required.
...
- Workspace file browser with inline editing, syntax highlighting, and a dedicated Markdown editor
