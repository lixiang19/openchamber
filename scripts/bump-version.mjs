...
if (fs.existsSync(cargoLockPath)) {
  try {
    ...
    if (anchorIndex !== -1) {
      ...
      console.warn(`Warning: could not find openaurora-desktop entry in ${CARGO_LOCK}`);
    }
  } catch (e) {
